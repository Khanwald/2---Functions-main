...
func progressUpdate(){
    switch steps{
    case 0...(goal * 10/100): print("Youre off to a good start")
    case 0...(goal/2 - 1): print("Youre almost halfway there!")
    case 0...(goal * 90/100): print("Youre almost there!")
    case goal: print("You beat your goal!")
    default: print("cat")
    }
}
